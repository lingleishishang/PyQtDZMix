...
#        
    ...
    def on_pushButton_13_clicked(self):
        ...
        if num == 2 and self.radioButton.isChecked():
            ...
            Ratio_A = [i/100 for i in range(101)]
            self.aa = [
                r.calculate_cross_correlation(self.np_sample, (i/100)*self.np_source[0] + ((100-i)/100)*self.np_source[1])[0]
                for i in range(101)
            ]
            self.slope = [
                r.calculate_cross_correlation(self.np_sample, (i/100)*self.np_source[0] + ((100-i)/100)*self.np_source[1])[1]
                for i in range(101)
            ]
            self.intercept = [
                r.calculate_cross_correlation(self.np_sample, (i/100)*self.np_source[0] + ((100-i)/100)*self.np_source[1])[2]
                for i in range(101)
            ]
            self.max_aa=np.max(self.aa)
            self.max_aa_index=np.argmax(self.aa)
...
#        
    ...
    def on_pushButton_16_clicked(self):
        ...
        if num == 2 and self.radioButton.isChecked():
            ...
            Ratio_A = [i/100 for i in range(101)]
            self.aa = [
                lk.Likeness(self.np_sample, (i/100)*self.np_source[0] + ((100-i)/100)*self.np_source[1])
                for i in range(101)
            ]
            self.max_aa=np.max(self.aa)
            self.max_aa_index=np.argmax(self.aa)
